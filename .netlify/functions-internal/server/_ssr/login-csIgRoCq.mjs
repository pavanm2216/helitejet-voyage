...
import { a as useAuth, n as dashboardForRole } from "./auth-B5gn9oy0.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/login-csIgRoCq.js
...
function LoginPage() {
	...
	async function submit(e) {
		...
		try {
			...
			if (profileError || !profile) throw new Error("Unable to load your profile.");
			await navigate({ to: dashboardForRole(profile.role) });
		} catch (err) {
