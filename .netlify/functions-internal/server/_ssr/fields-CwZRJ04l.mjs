...
//#region node_modules/.nitro/vite/services/ssr/assets/fields-CwZRJ04l.js
...
function TextField({ label, ...props }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
		className: `group relative block ${props.readOnly ? "opacity-50 cursor-default" : ""}`,
		children: [
			...
			!props.readOnly && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: underline })
		]
	});
}
