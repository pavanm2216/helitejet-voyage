...
import { d as mobilityContent, f as privateContent, h as subscriptionContent, l as membershipContent, m as scenes, n as aviationContent, o as destinationsContent, p as residencesContent, s as experiencesContent, t as aboutContent, v as yachtsContent } from "./site-FtusKPuW.mjs";
...
import { i as Lines, n as Kicker, o as SectionReveal, r as LineLink } from "./CinematicPage-CPGJjItP.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/sections-CnoRkywO.js
...
function SubscriptionsSections({ activeClub, activeStatus, onSelect, selecting }) {
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: c.clubs.map((club, i) => {
					...
					return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SectionReveal, {
						delay: i * .12,
						className: `group border bg-[oklch(0.12_0.008_275/0.8)] p-6 md:p-8 transition-colors duration-500 ${isActive ? "border-gold/60" : isPending ? "border-champagne/30" : "border-ivory/10"}`,
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									isPending && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "whisper text-champagne/60",
										children: "Pending"
									})
								]
							}),
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mt-3 font-serif text-xl font-light text-champagne/70",
								children: CLUB_PRICES[key]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mt-4 font-serif text-lg font-light leading-relaxed text-ivory/70",
								children: club.blurb
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: onSelect ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
									type: "button",
									disabled: isDisabled,
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: isSelecting ? "Opening…" : isActive ? "Active" : isPending ? "Awaiting confirmation" : "Request this club" }), !isDisabled && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Request this club" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "relative block h-px w-10 overflow-hidden bg-gold/50",
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "absolute inset-0 origin-left scale-x-0 bg-ivory transition-transform duration-700 ease-out group-hover:scale-x-100" })
									})]
								})
